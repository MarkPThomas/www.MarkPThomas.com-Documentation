...
CREATE TABLE IF NOT EXISTS `mountaineering`.`climbing_rack_to_tricams` (
  `tricams_quantity` INT NULL,
  `notes` VARCHAR(45) NULL,
  `tricams_quantity_optional` INT NULL,
  `notes_quantity_optional` VARCHAR(45) NULL,
  `tricams_id` INT NOT NULL,
  `climbing_rack_id` INT NOT NULL,
  PRIMARY KEY (`tricams_id`, `climbing_rack_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`climbing_rack_to_hexes` (
  `hexes_quantity` INT NULL,
  `notes` VARCHAR(45) NULL,
  `hexes_quantity_optional` INT NULL,
  `notes_quantity_optional` VARCHAR(45) NULL,
  `hexes_id` INT NOT NULL,
  `climbing_rack_id` INT NOT NULL,
  PRIMARY KEY (`hexes_id`, `climbing_rack_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`climbing_rack_to_SLCDs` (
  `SLCD_quantity` INT NULL,
  `notes` VARCHAR(45) NULL,
  `SLCD_quantity_optional` INT NULL,
  `notes_quantity_optional` VARCHAR(45) NULL,
  `SLCD_id` INT NOT NULL,
  `climbing_rack_id` INT NOT NULL,
  PRIMARY KEY (`SLCD_id`, `climbing_rack_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`climbing_rack_to_slings` (
  `slings_quantity` INT NULL,
  `notes` VARCHAR(45) NULL,
  `slings_quantity_optional` INT NULL,
  `notes_quantity_optional` VARCHAR(45) NULL,
  `sling_id` INT NOT NULL,
  `climbing_rack_id` INT NOT NULL,
  PRIMARY KEY (`sling_id`, `climbing_rack_id`),
...
-- -----------------------------------------------------
-- Table `mountaineering`.`topo_files`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mountaineering`.`topo_files` ;

CREATE TABLE IF NOT EXISTS `mountaineering`.`topo_files` (
...
-- -----------------------------------------------------
-- Table `mountaineering`.`ge_files`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mountaineering`.`ge_files` ;

CREATE TABLE IF NOT EXISTS `mountaineering`.`ge_files` (
...
-- -----------------------------------------------------
-- Table `mountaineering`.`gpx_files`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mountaineering`.`gpx_files` ;

CREATE TABLE IF NOT EXISTS `mountaineering`.`gpx_files` (
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`map_resources_to_topo_files` (
  ...
  CONSTRAINT `fk_map_resources_to_topo_files_topo_files1`
    ...
    REFERENCES `mountaineering`.`topo_files` (`topo_file_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`map_resources_to_ge_files` (
  ...
  CONSTRAINT `fk_map_resources_to_ge_files_ge_files1`
    ...
    REFERENCES `mountaineering`.`ge_files` (`ge_file_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`map_resources_to_gpx_files` (
  ...
  CONSTRAINT `fk_map_resources_to_gpx_files_gpx_files1`
    ...
    REFERENCES `mountaineering`.`gpx_files` (`gpx_file_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`routes` (
  ...
  `map_resources_map_resources_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`photo_albums` (
  ...
  `photo_album_url` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`lists_features` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`feature_list_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`state_or_country` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`state_or_country_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`regions` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`region_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`locations` (
  ...
  `state_or_country_pages_page_id` INT NOT NULL,
  `regions_region_id` INT NOT NULL,
  `regions_pages_page_id` INT NOT NULL,
  PRIMARY KEY (`location_id`, `state_or_country_state_or_country_id`, `state_or_country_pages_page_id`, `regions_region_id`, `regions_pages_page_id`),
  INDEX `fk_locations_state_or_country1_idx` (`state_or_country_state_or_country_id` ASC, `state_or_country_pages_page_id` ASC),
  INDEX `fk_locations_regions1_idx` (`regions_region_id` ASC, `regions_pages_page_id` ASC),
  CONSTRAINT `fk_locations_state_or_country1`
    FOREIGN KEY (`state_or_country_state_or_country_id` , `state_or_country_pages_page_id`)
    REFERENCES `mountaineering`.`state_or_country` (`state_or_country_id` , `pages_page_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_locations_regions1`
    FOREIGN KEY (`regions_region_id` , `regions_pages_page_id`)
    REFERENCES `mountaineering`.`regions` (`region_id` , `pages_page_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`geography_region_level_1` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`geography_region_level_1_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`geography_region_level_2` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`geography_region_level_2_id`, `geography_region_level_2_geography_region_level_1_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`geography_region_level_3` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`geography_region_level_3_id`, `geography_region_level_3_geography_region_level_2_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`geography_region_level_4` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`geography_region_level_4_id`, `geography_region_level_4_geography_region_level_3_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`geography_region_level_5` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`geography_region_level_5_id`, `geography_region_level_5_geography_region_level_4_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`geography_region_level_6` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`geography_region_level_6_id`, `geography_region_level_6_geography_region_level_5_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`geography_regions` (
  ...
  `geography_region_level_2_geography_region_level_2_id` INT NOT NULL,
  `geography_region_level_3_geography_region_level_3_id` INT NOT NULL,
  `geography_region_level_4_geography_region_level_4_id` INT NOT NULL,
  `geography_region_level_5_geography_region_level_5_id` INT NOT NULL,
  `geography_region_level_6_geography_region_level_6_id` INT NOT NULL,
  PRIMARY KEY (`geography_regions_id`, `geography_region_level_1_geography_region_level_1_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`peak_or_feature` (
  ...
  `geography_regions_geography_regions_id` INT NOT NULL,
  PRIMARY KEY (`peak_or_feature_id`, `pages_page_id`, `locations_location_id`, `geography_regions_geography_regions_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`lists_to_features` (
  ...
  PRIMARY KEY (`lists_features_feature_list_id`, `peak_or_feature_peak_or_feature_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`lists_to_routes` (
  ...
  `lists_routes_pages_page_id` INT NOT NULL,
  PRIMARY KEY (`routes_route_id`, `lists_routes_route_list_id`, `lists_routes_pages_page_id`),
  INDEX `fk_lists_to_routes_lists_routes1_idx` (`lists_routes_route_list_id` ASC, `lists_routes_pages_page_id` ASC),
  ...
  CONSTRAINT `fk_lists_to_routes_lists_routes1`
    FOREIGN KEY (`lists_routes_route_list_id` , `lists_routes_pages_page_id`)
    REFERENCES `mountaineering`.`lists_routes` (`route_list_id` , `pages_page_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_trips` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`report_trip_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`tick_list` (
  ...
  `peak_or_feature_peak_or_feature_id` INT NOT NULL,
  `routes_route_id` INT NOT NULL,
  PRIMARY KEY (`tick_list_id`, `pages_page_id`, `peak_or_feature_peak_or_feature_id`, `routes_route_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_trips_introduction` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`report_trip_introduction_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_trips_summary` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`report_trip_summary_id`, `pages_page_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`trailheads` (
  ...
  `trailhead_classifications` SET('Hiking', 'Cragging', 'Cycling', 'Watercraft') NOT NULL,
  `trailhead_latitude` DOUBLE NOT NULL,
  `trailhead_longitude` DOUBLE NOT NULL,
  `trailhead_elevation` INT(11) NULL,
  `trailhead_developed` ENUM('Yes', 'No', 'Unknown') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`path` (
  ...
  `path_start_trailhead_id` INT NOT NULL,
  `path_end_trailhead_id` INT NULL,
  `path_description` VARCHAR(45) NOT NULL,
  `path_distance` DOUBLE NOT NULL COMMENT 'Miles. From segment sums.\n',
  `path_elevation_gain` INT(11) NOT NULL COMMENT 'Feet.  From segment sums.\n',
  `path_elevation_loss` INT(11) NOT NULL COMMENT 'Feet.  From segment sums.\n',
  PRIMARY KEY (`path_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`trips` (
  ...
  `trip_reports_trip_report_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`day_overwrites_to_route` (
  ...
  `climbing_rack_climbing_rack_id` INT NOT NULL,
  `technical_rating_technical_rating_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`path_descents` (
  ...
  `segment_sequence_id` INT(11) NULL COMMENT 'Counts up in order of addition to path\n',
  `segment_forward` TINYINT(1) NULL COMMENT 'Determines which direction the segment goes\n',
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`path_route_total_key` (
  ...
  `path_routes_routes_id` INT NOT NULL,
  `path_descents_descent_id` INT NOT NULL,
  PRIMARY KEY (`path_path_id`, `path_approaches_approach_id`, `path_routes_routes_id`, `path_descents_descent_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_photos` (
  ...
  PRIMARY KEY (`report_photo_id`, `photos_photo_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_videos` (
  ...
  PRIMARY KEY (`report_video_id`, `videos_video_id`),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_trip_summary_bodies` (
  ...
  `report_id` INT NULL,
  `report_type` ENUM('Trip', 'Summary', 'Introduction', 'Article') NULL,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_articles` (
  ...
  `pages_page_id` INT NOT NULL,
  PRIMARY KEY (`report_article_id`, `pages_page_id`),
  INDEX `fk_trip_reports_pages1_idx` (`pages_page_id` ASC),
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_trips_has_photo_albums` (
  `report_trips_report_trip_id` INT NOT NULL,
  `report_trips_pages_page_id` INT NOT NULL,
  `photo_albums_photo_album_id` INT NOT NULL,
  PRIMARY KEY (`report_trips_report_trip_id`, `report_trips_pages_page_id`, `photo_albums_photo_album_id`),
  INDEX `fk_report_trips_has_photo_albums_photo_albums1_idx` (`photo_albums_photo_album_id` ASC),
  INDEX `fk_report_trips_has_photo_albums_report_trips1_idx` (`report_trips_report_trip_id` ASC, `report_trips_pages_page_id` ASC),
  CONSTRAINT `fk_report_trips_has_photo_albums_report_trips1`
    FOREIGN KEY (`report_trips_report_trip_id` , `report_trips_pages_page_id`)
    REFERENCES `mountaineering`.`report_trips` (`report_trip_id` , `pages_page_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mountaineering`.`report_articles_has_photo_albums` (
  `report_articles_report_article_id` INT NOT NULL,
  `report_articles_pages_page_id` INT NOT NULL,
  `photo_albums_photo_album_id` INT NOT NULL,
  PRIMARY KEY (`report_articles_report_article_id`, `report_articles_pages_page_id`, `photo_albums_photo_album_id`),
  INDEX `fk_report_articles_has_photo_albums_photo_albums1_idx` (`photo_albums_photo_album_id` ASC),
  INDEX `fk_report_articles_has_photo_albums_report_articles1_idx` (`report_articles_report_article_id` ASC, `report_articles_pages_page_id` ASC),
  CONSTRAINT `fk_report_articles_has_photo_albums_report_articles1`
    FOREIGN KEY (`report_articles_report_article_id` , `report_articles_pages_page_id`)
    REFERENCES `mountaineering`.`report_articles` (`report_article_id` , `pages_page_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
USE `mountaineering`;
DROP  IF EXISTS `mountaineering`.`routine1`;
